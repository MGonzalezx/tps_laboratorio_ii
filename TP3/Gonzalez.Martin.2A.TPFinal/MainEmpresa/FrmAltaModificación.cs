...
namespace MainEmpresa
{
    public partial class FrmAltaModificacion : Form
    {
        ...
        /// <param name="btnConfirmarText">Texto del boton para confirmar</param>
        public FrmAltaModificacion(string titulo, Cliente itemAEditar, string btnConfirmarText) : this(titulo, itemAEditar.Nombre, itemAEditar.Apellido, itemAEditar.NumeroAfiliado, itemAEditar.Requerimiento, btnConfirmarText)
        {
